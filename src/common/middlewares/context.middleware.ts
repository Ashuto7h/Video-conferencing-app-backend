...
export const withContext = (request: Request, response: Response, next: NextFunction) => {
    runWithContext(() => next(), {});
};

export const withCorrelationId = (request: Request, response: Response, next: NextFunction) => {
